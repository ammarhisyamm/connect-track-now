...
type KacabActivityItem = { kcp: string; date: string; time: string; title: string; activityTypes?: string[]; place: string; region: string; priority: string };
const ITEMS: KacabActivityItem[] = [
   { kcp: "MAS MONANG-MANING", date: "2026-06-28", time: "15:00 - 16:00 WIB", title: "Evaluasi Pencapaian Target Unit & Sales", activityTypes: ["Evaluasi Pencapaian Target Unit & Sales"], place: "Balai Desa Kelurahan Pilumpanua", region: "Wajo, Sulawesi Selatan", priority: "High" },
   { kcp: "MAS RAWAMANGUN", date: "2026-06-06", time: "09:00 - 10:00 WIB", title: "Visit Nasabah One Obligor", activityTypes: ["Visit Nasabah One Obligor"], place: "KCP Rawamangun", region: "Jakarta Timur, DKI Jakarta", priority: "Medium" },
];
